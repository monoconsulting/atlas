...
class Task:
    ...
    Attributes:
        ...
        estimate: Optional effort estimate (free text, e.g. "4h", "2d").
        labels: Optional list of label strings.
        dependencies: Optional list of related task IDs (back-compat: also mirrored to 'relations').
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        """
        d = asdict(self)
        # Maintain back-compat: mirror dependencies -> relations
...
class AddTaskRequest:
    ...
    Attributes:
        ...
        dependencies: Optional list of related task IDs.
    """
    title: str
    description: str
    priority: str = "medium"
...
class UpdateTaskRequest:
    ...
    Attributes:
        ...
        dependencies: Optional new dependencies list (replaces existing).
    """
